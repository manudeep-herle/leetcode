<h1>1731 - Even Odd Tree</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/even-odd-tree/">even-odd-tree</a></h2><p>A binary tree is named <strong>Even-Odd</strong> if it meets the following conditions:</p>
