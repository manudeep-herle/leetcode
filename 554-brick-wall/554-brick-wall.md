<h1>554 - Brick Wall</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/brick-wall/">brick-wall</a></h2><p>There is a rectangular brick wall in front of you with <code>n</code> rows of bricks. The <code>i<sup>th</sup></code> row has some number of bricks each of the same height (i.e., one unit) but they can be of different widths. The total width of each row is the same.</p>
