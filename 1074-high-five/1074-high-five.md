<h1>1074 - High Five</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/high-five/">high-five</a></h2><p>Given a list of the scores of different students, <code>items</code>, where <code>items[i] = [ID<sub>i</sub>, score<sub>i</sub>]</code> represents one score from a student with <code>ID<sub>i</sub></code>, calculate each student&#39;s <strong>top five average</strong>.</p>
