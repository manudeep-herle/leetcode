<h1>1350 - Remove Sub-Folders from the Filesystem</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/remove-sub-folders-from-the-filesystem/">remove-sub-folders-from-the-filesystem</a></h2><p>Given a list of folders <code>folder</code>, return <em>the folders after removing all <strong>sub-folders</strong> in those folders</em>. You may return the answer in <strong>any order</strong>.</p>
