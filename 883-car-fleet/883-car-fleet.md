<h1>883 - Car Fleet</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/car-fleet/">car-fleet</a></h2><p>There are <code>n</code> cars at given miles away from the starting mile 0, traveling to reach the mile <code>target</code>.</p>
